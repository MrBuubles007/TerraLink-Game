...
const Brochure = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden p-6 md:p-12 relative flex flex-col items-center selection:bg-cyan-500/30 selection:text-cyan-200">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                <motion.div
                    ...
                    className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-pink-600/10 rounded-full blur-[120px]"
                />
                ...
                <motion.div
                    ...
                    className="absolute left-0 w-full h-2 bg-gradient-to-b from-transparent via-cyan-500/10 to-transparent blur-sm"
                />
            </div>
            ...
            <div className="max-w-7xl w-full z-10 space-y-32 mb-20">
                ...
                <section className="text-center py-20 relative">
                    <motion.div
                        ...
                        className="inline-block border-2 border-cyan-400 bg-black/60 backdrop-blur-md px-12 py-6 mb-8 shadow-[0_0_20px_rgba(34,211,238,0.3)] transform -skew-x-12 relative group"
                    >
                        {/* Glitch overlay on hover */}
                        <div className="absolute inset-0 bg-cyan-400/20 opacity-0 group-hover:opacity-100 transition duration-100 mix-blend-overlay"></div>
                    ...
                    <motion.h2
                        ...
                        className="text-2xl md:text-4xl font-light text-gray-300 uppercase border-b-2 border-pink-500/50 pb-4 inline-block"
                    >
                        Classified Dossier
                    </motion.h2>
                </section>
                ...
                <section className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <motion.h3 variants={itemVariants} className="text-4xl font-bold text-green-400 uppercase tracking-wider mb-6 flex items-center gap-4">
                            <span className="w-10 h-10 rounded-full border border-green-400 flex items-center justify-center text-base shadow-[0_0_10px_inset_rgba(34,197,94,0.5)]">01</span>
                            Global Connection
                        </motion.h3>
                    ...
                    <motion.div
                        ...
                        onClick={() => setSelectedImage(`/assets/brochure/world_map_placeholder.png${v}`)}
                    >
                        ...
                        <div className="relative rounded-lg overflow-hidden border border-white/10 bg-black shadow-2xl">
                            ...
                            <img
                                src={`/assets/brochure/world_map_placeholder.png${v}`}
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-black/80 border-t border-green-500/30 flex justify-between text-xs font-mono text-green-400">
                                <span className="animate-pulse">SYS.MAP.V4.0 // CLICK TO EXPAND</span>
                ...
                <section className="grid md:grid-cols-2 gap-16 items-center md:flex-row-reverse">
                    ...
                    >
                        ...
                        <motion.h3 variants={itemVariants} className="text-4xl font-bold text-orange-400 uppercase tracking-wider mb-6 flex items-center justify-end gap-4 text-right">
                            System Mechanics
                            <span className="w-10 h-10 rounded-full border border-orange-400 flex items-center justify-center text-base shadow-[0_0_10px_inset_rgba(249,115,22,0.5)]">02</span>
                        </motion.h3>
                    ...
                    <motion.div
                        ...
                        onClick={() => setSelectedImage(`/assets/brochure/gameplay_placeholder.png${v}`)}
                    >
                        ...
                        <div className="relative rounded-lg overflow-hidden border border-white/10 bg-black shadow-2xl">
                            ...
                            <img
                                src={`/assets/brochure/gameplay_placeholder.png${v}`}
                            ...
                            <div className="absolute bottom-4 right-4 text-orange-400 font-mono text-xs tracking-widest animate-pulse">
                                CLICK TO ANALYZE
                            </div>
                        </div>
                    </motion.div>
                ...
                <section className="grid md:grid-cols-2 gap-16 items-start">
                    <motion.div
                        ...
                        onClick={() => setSelectedImage(`/assets/brochure/poster_placeholder.png${v}`)}
                    >
                        ...
                        <div className="relative rounded-sm overflow-hidden border-4 border-pink-500/20 bg-black max-w-md w-full shadow-[0_0_50px_rgba(236,72,153,0.2)]">
                            ...
                            <img
                                src={`/assets/brochure/poster_placeholder.png${v}`}
                                alt="Analysis Poster"
                    ...
                    >
                        <motion.div variants={itemVariants} className="bg-black/60 border-l-4 border-pink-500 pl-8 py-4 backdrop-blur-sm">
                        ...
                        <div className="space-y-8 text-gray-300 text-lg leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 gap-5">
                                <motion.div variants={itemVariants} whileHover={{ x: 10, backgroundColor: "rgba(255,255,255,0.1)" }} className="bg-white/5 border border-white/10 p-5 rounded flex items-center gap-6 transition group cursor-default">
                                    <div className="text-5xl font-bold text-cyan-400 w-28 text-right group-hover:text-cyan-300 transition">69%</div>
                                ...
                                <motion.div variants={itemVariants} whileHover={{ x: 10, backgroundColor: "rgba(255,255,255,0.1)" }} className="bg-white/5 border border-white/10 p-5 rounded flex items-center gap-6 transition group cursor-default">
                                    <div className="text-5xl font-bold text-pink-500 w-28 text-right group-hover:text-pink-400 transition">44%</div>
                                    <div className="border-l border-white/20 pl-6">
                                ...
                                <motion.div variants={itemVariants} whileHover={{ x: 10, backgroundColor: "rgba(255,255,255,0.1)" }} className="bg-white/5 border border-white/10 p-5 rounded flex items-center gap-6 transition group cursor-default">
                                    <div className="text-5xl font-bold text-orange-400 w-28 text-right group-hover:text-orange-300 transition">57%</div>
                                    <div className="border-l border-white/20 pl-6">
                                ...
                                <motion.div variants={itemVariants} whileHover={{ x: 10, backgroundColor: "rgba(255,255,255,0.1)" }} className="bg-white/5 border border-white/10 p-5 rounded flex items-center gap-6 transition group cursor-default">
                                    <div className="text-5xl font-bold text-red-500 w-28 text-right group-hover:text-red-400 transition">80%</div>
                                    <div className="border-l border-white/20 pl-6">
                            ...
                            <motion.p variants={itemVariants} className="border-t border-gray-700 pt-6 italic text-gray-400">
            ...
            <AnimatePresence>
                {selectedImage && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-xl p-4 cursor-pointer"
                    ...
                    >
                        ...
                        />
                        <button className="absolute top-8 right-8 text-white text-xl border border-white/30 rounded-full w-12 h-12 flex items-center justify-center hover:bg-white/20 transition group">
                            <span className="group-hover:rotate-90 transition transform">✕</span>
                        </button>
                        <div className="absolute bottom-8 text-gray-400 font-mono text-sm tracking-widest animate-pulse">
